...
const fetchPostsForThread = (myThread) => {
    ...
    .then(data => {
      ...
      data.forEach(post => {
        ...
        if (postExists && !sameButDifferent) {
          ...
          const formElement = document.querySelector(`#thread-${myThread.id} .reply-form`);
          ...
          if (formElement) {
            ...
            console.log("no form");
            const threadElement = document.querySelector(`#thread-${myThread.id}`);
